...
export class SQLAdminFetcher {
    ...
    async getInstanceMetadata({ projectId, regionId, instanceId, }) {
        ...
        return {
            ipAddresses,
            serverCaCert: serverCaCert && serverCaCert.cert && serverCaCert.expirationTime
                ? {
    ...
    async resolveConnectSettings(region, dnsName) {
        const client = await this.adminAuth.getClient();
        let rootUrl = this.client.context._options.rootUrl ||
