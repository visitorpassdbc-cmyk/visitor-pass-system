...
import { resolveInstanceName } from './parse-instance-connection-name.js';
import { SqlDataClient } from './sql-data-client.js';
export function cooldownBackoff(base, attempt) {
    const multi = 1.618;
...
export class Connector {
    ...
    async getOptions(opts) {
        ...
        const instanceInfo = await resolveInstanceName(opts.instanceConnectionName, opts.domainName, this.sqlAdminFetcher);
