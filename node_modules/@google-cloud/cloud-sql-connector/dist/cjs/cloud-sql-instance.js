...
class CloudSQLInstance {
    static async getCloudSQLInstance(options) {
        const instanceInfo = await (0, parse_instance_connection_name_1.resolveInstanceName)(options.instanceConnectionName, options.domainName, options.sqlAdminFetcher);
    ...
    constructor({ options, instanceInfo, }) {
        ...
        if (instanceInfo) {
            ...
            this.instanceInfo = (0, parse_instance_connection_name_1.parseInstanceConnectionName)(options.instanceConnectionName);
        }
    ...
    refresh() {
        ...
        const isInstanceDNS = (0, parse_instance_connection_name_1.isInstanceDNSName)(((_a = this.instanceInfo) === null || _a === void 0 ? void 0 : _a.domainName) || '');
        ...
        this.next = (this.throttle && this.scheduledRefreshID
            ...
            if (this.ephemeralCert) {
                refreshInterval = (0, time_1.getRefreshInterval)(this.ephemeralCert.expirationTime);
            }
    ...
    async performRefresh() {
        ...
        let ephemeralCert;
        let privateKey;
        if (this.ipType !== ip_addresses_1.IpAddressTypes.SQL_DATA) {
    ...
    async checkDomainChanged() {
        ...
        try {
            const newInfo = await (0, parse_instance_connection_name_1.resolveInstanceName)(undefined, this.instanceInfo.domainName, this.sqlAdminFetcher);
    ...
    isNonTransient(err) {
        if (err instanceof errors_1.CloudSQLConnectorError) {
