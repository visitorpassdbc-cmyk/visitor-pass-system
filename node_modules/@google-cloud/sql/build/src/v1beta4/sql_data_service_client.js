...
exports.SqlDataServiceClient = void 0;
 ...
 */
const gapicConfig = require("./sql_data_service_client_config.json");
...
class SqlDataServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.stream = {
            streamSqlData: new this._gaxModule.StreamDescriptor(this._gaxModule.StreamType.BIDI_STREAMING, !!opts.fallback, !!opts.gaxServerStreamingRetries),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.sql.v1beta4.SqlDataService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sqlDataServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.sql.v1beta4.SqlDataService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.sql.v1beta4.SqlDataService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const sqlDataServiceStubMethods = ['streamSqlData'];
        for (const methodName of sqlDataServiceStubMethods) {
            const callPromise = this.sqlDataServiceStub.then((stub) => (...args) => {
                if (this._terminated) {
...
exports.SqlDataServiceClient = SqlDataServiceClient;
//# sourceMappingURL=sql_data_service_client.js.map