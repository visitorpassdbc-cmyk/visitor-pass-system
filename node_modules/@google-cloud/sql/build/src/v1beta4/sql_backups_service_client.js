...
exports.SqlBackupsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./sql_backups_service_client_config.json");
...
class SqlBackupsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.sql.v1beta4.SqlBackupsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sqlBackupsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.sql.v1beta4.SqlBackupsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.sql.v1beta4.SqlBackupsService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of sqlBackupsServiceStubMethods) {
            const callPromise = this.sqlBackupsServiceStub.then((stub) => (...args) => {
                if (this._terminated) {
    ...
    createBackup(request, optionsOrCallback, callback) {
        ...
        return (_b = this.innerApiCalls
            .createBackup(request, options, wrappedCallback)) === null || _b === void 0 ? void 0 : _b.then(([response, options, rawResponse]) => {
            this._log.info('createBackup response %j', response);
    ...
    getBackup(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return (_b = this.innerApiCalls
            .getBackup(request, options, wrappedCallback)) === null || _b === void 0 ? void 0 : _b.then(([response, options, rawResponse]) => {
            this._log.info('getBackup response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
            if (error &&
    ...
    updateBackup(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return (_b = this.innerApiCalls
            .updateBackup(request, options, wrappedCallback)) === null || _b === void 0 ? void 0 : _b.then(([response, options, rawResponse]) => {
            this._log.info('updateBackup response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
            if (error &&
    ...
    deleteBackup(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return (_b = this.innerApiCalls
            .deleteBackup(request, options, wrappedCallback)) === null || _b === void 0 ? void 0 : _b.then(([response, options, rawResponse]) => {
            this._log.info('deleteBackup response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
            if (error &&
    ...
    listBackups(request, optionsOrCallback, callback) {
        ...
        return (_b = this.innerApiCalls
            .listBackups(request, options, wrappedCallback)) === null || _b === void 0 ? void 0 : _b.then(([response, input, output]) => {
...
exports.SqlBackupsServiceClient = SqlBackupsServiceClient;
//# sourceMappingURL=sql_backups_service_client.js.map