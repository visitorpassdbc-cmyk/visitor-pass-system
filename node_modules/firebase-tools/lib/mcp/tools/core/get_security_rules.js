...
exports.get_security_rules = (0, tool_1.tool)("core", {
    ...
    humanReadableDescription: "Retrieve the active security rules for Firestore, Storage, or Realtime Database.",
    ...
    if (type === "rtdb") {
        ...
        const rules = await (0, streamUtils_1.streamToString)(response.body);
