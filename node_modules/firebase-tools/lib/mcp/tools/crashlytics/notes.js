...
exports.create_note = (0, tool_1.tool)("crashlytics", {
    name: "create_note",
    description: "Add a note to an issue from crashlytics. Only supported for mobile (Android and iOS) apps.",
...
exports.list_notes = (0, tool_1.tool)("crashlytics", {
    name: "list_notes",
    description: "Use this to list all notes for an issue in Crashlytics. Only supported for mobile (Android and iOS) apps.",
    humanReadableDescription: "List all notes attached to a Crashlytics issue for an Android or iOS app.",
    inputSchema: zod_1.z.object({
        appId: filters_1.ApplicationIdSchema,
        issueId: filters_1.IssueIdSchema,
...
exports.delete_note = (0, tool_1.tool)("crashlytics", {
    name: "delete_note",
    description: "Delete a note from a Crashlytics issue. Only supported for mobile (Android and iOS) apps.",
