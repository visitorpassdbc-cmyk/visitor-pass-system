...
exports.run_tests = (0, tool_1.tool)("apptesting", {
    ...
    humanReadableDescription: "Run an automated test case on a remote Android or iOS device via Firebase App Distribution.",
...
exports.check_status = (0, tool_1.tool)("apptesting", {
    ...
    humanReadableDescription: "Check the status of an automated release test or list available test devices.",
    inputSchema: zod_1.z.object({
