...
exports.ensureInstanceSpec = ensureInstanceSpec;
...
async function ensureInstanceSpec(instance) {
    ...
    const extensionVersion = instance.config?.extensionVersion ?? instance.extensionVersion ?? ref.version ?? "latest";
    const extVersion = await (0, publisherApi_1.getExtensionVersion)(`${ref.publisherId}/${ref.extensionId}@${extensionVersion}`);
    return {
        ...instance,
        config: {
            ...instance.config,
            source: {
                ...
                state: instance.config?.source?.state ??
